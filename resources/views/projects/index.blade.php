...
<div class="d-flex justify-content-end">
    ...
    <a href="{{ route('admin.project.create') }}" class="btn btn-success m-1">
        ...
        <table  id="Project" class="table">
            ...
            <tbody>
                @foreach($projects as $project)
						...
						<td>
                    <a href="{{ route('admin.project.show', ['id' => $project->id]) }}" class="btn btn-primary btn-sm">
                        <i class="fa-solid fa-eye"></i>
                    </a>
                    <a href="{{ route('admin.project.edit', ['id' => $project->id]) }}" class="btn btn-success btn-sm">
...
@section('scripts')
    ...
    <script>
        ...
        checkbox.onchange = async (event) => {
            ...
            const response = await fetch('/admin/projects/speed/' + id, {
                method: 'PUT',
