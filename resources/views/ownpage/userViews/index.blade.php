...
<div class="d-flex justify-content-end">
    ...
    <a href="{{ route('createUser') }}" class="btn btn-success m-1">
...
<div class="">
        ...
        <table  id="User" class="table">
            ...
            <tbody>
                @foreach($users as $user)
						...
						<td>
                    <a href="{{ route('showUser', ['id' => $user->id]) }}" class="btn btn-primary btn-sm">
                        <i class="bi bi-eye"></i>
                    </a>
                    <a href="{{ route('editUser', ['id' => $user->id]) }}" class="btn btn-success btn-sm">
    ...
    <script>
        ...
        checkbox.onchange = async (event) => {
            ...
            const response = await fetch('/users/speed/' + id, {
                method: 'PUT',
