    ...
    <div class="row">
        <div class="col-md-8">
            <form action="{{ isset($organization) ? route('updateOrganization', ['organization' => $organization->id]) : route('storeOrganization') }}" method="POST">
                @csrf
                ...
                <div class="mb-3">
                    ...
                    <select name="status" id="status" class="form-control">
                        <option value="">Choisir le statut de l'organisation</option>
                        <option value="active">Actif</option>
                        <option value="inactive">Inacatif</option>
                    ...
                    @enderror
                </div> <a href="{{ route('indexOrganization') }}" class="btn btn-danger mt-1">
                    Cancel
                </a>
