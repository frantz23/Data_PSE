        ...
        <div class="card border-0 shadow-sm">
            ...
            <div class="card-header bg-white py-3 border-0 d-flex align-items-center justify-content-between">
                <div>
                    ...
                    <small class="text-muted">Définissez les paramètres globaux et le cadrage du
                        programme</small>
                </div>
            ...
            <div class="card-body p-4">
                <form
                    action="{{ isset($program) ? route('updateProgram', ['program' => $program->id]) : route('storeProgram') }}"
                    method="POST">
                    @csrf
                    @if (isset($program))
                        @method('PUT')
                    ...
                    <div class="mb-4">
                        ...
                        <div class="row g-3">
                            ...
                            <!-- Nom du Programme -->
                            <div class="col-md-8">
                                <label for="name" class="form-label fw-semibold">Nom
                                    du Programme <span class="text-danger">*</span></label>
                            ...
                            <!-- Description -->
                            <div class="col-12">
                                <label for="description" class="form-label fw-semibold">Description du Programme <span
                    ...
                    <div class="mb-4">
                        <h6 class="fw-bold text-primary border-bottom pb-2 mb-3">
                            <i class="bi bi-cash-stack me-1"></i> 2. Financement &
                            Partenaires
                        </h6>
                        <div class="row g-3">
                            <!-- Donor / Bailleur -->
                            <div class="col-md-6">
                                <label for="donor_id" class="form-label fw-semibold">Bailleur de Fonds (Donor) <span
                                        class="text-danger">*</span></label>
                                <select name="donor_id" id="donor_id" class="form-select select2" required>
                                    <option value="">-- Choisir le bailleur --</option>
                                    @foreach ($donors as $d)
                                        <option value="{{ $d->id }}"
                                            {{ old('donor', $program->donor ?? '') == $d->id ? 'selected' : '' }}>
                                            {{ $d->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <!-- Funding Partner -->
                            <div class="col-md-6">
                                <label for="funding_partner" class="form-label fw-semibold">Partenaire de Mise en Œuvre
                                    / Financement <span class="text-danger">*</span></label>
                            ...
                            <!-- Budget -->
                            <div class="col-md-8">
                                <label for="budget" class="form-label fw-semibold">Budget Total Alloué <span
                                        class="text-danger">*</span></label>
                            ...
                            <!-- Currency -->
                            <div class="col-md-4">
                                <label for="currency" class="form-label fw-semibold">Devise <span
                                        class="text-danger">*</span></label>
                                <select name="currency" id="currency"
                                    class="form-select @error('currency') is-invalid @enderror" required>
                                    <option value="">-- Choisir la devise --
                                    </option>
                                    <option value="FCFA"
                    ...
                    <div class="mb-4">
                        <h6 class="fw-bold text-primary border-bottom pb-2 mb-3">
                            <i class="bi bi-calendar-range me-1"></i> 3. Calendrier &
                            Statut
                        </h6>
                        <div class="row g-3">
                            <!-- Start Date -->
                            ...
                            <!-- Status -->
                            <div class="col-md-4">
                                <label for="status" class="form-label fw-semibold">Statut du Programme <span
                                        class="text-danger">*</span></label>
                                <select name="status" id="status"
                                    class="form-select @error('status') is-invalid @enderror" required>
                                    <option value="">-- Sélectionner le
                                        Statut --</option>
                                    <option value="draft"
                                        {{ old('status', $program->status ?? '') == 'draft' ? 'selected' : '' }}>
                                        Brouillon</option>
                                    <option value="active"
                                        {{ old('status', $program->status ?? 'active') == 'active' ? 'selected' : '' }}>
