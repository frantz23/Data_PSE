            ...
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-header bg-white py-3 border-0 d-flex align-items-center justify-content-between">
                    <div>
                        ...
                        <small class="text-muted">Définissez les paramètres, l'attribution et le calendrier de
                            réalisation</small>
                    </div>
                ...
                <div class="card-body p-4">
                    <form
                        action="{{ isset($activity) ? route('updateActivity', ['activity' => $activity->id]) : route('storeActivity') }}"
                        method="POST">
                        @csrf
                        @if (isset($activity))
                            @method('PUT')
                        ...
                        @if ($errors->any())
                            <div class="alert alert-danger alert-dismissible fade show border-0 shadow-sm mb-4"
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <strong>Des erreurs sont survenues :</strong> Veuillez vérifier les champs du
                                        formulaire.
                                    </div>
                                </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="row g-3">
                                <!-- Projet Rattaché -->
                                <div class="col-md-4">
                                    <label for="project_id" class="form-label fw-semibold">Projet Rattaché <span
                                ...
                                <div class="col-md-4">
                                    <label for="parent_activity_id" class="form-label fw-semibold">Sous-activité
                                        de</label>
                                    <select name="parent_activity_id" id="parent_activity_id"
                                ...
                                <div class="col-md-4">
                                    <label for="assigned_to" class="form-label fw-semibold">Responsable / Assigné
                                        à</label>
                            ...
                            <div class="col-md-4 mb-3">
                                <label for="code" class="form-label fw-semibold">Code de l'activité <span
                                        class="text-danger">*</span></label>
                                <input type="text" name="code" id="code"
                                    class="form-control @error('code') is-invalid @enderror"
                                    value="{{ old('code', $activity->code ?? '') }}" placeholder="Ex: ACT-2026-001"
                                    required>
                                @error('code')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="mb-4">
                            ...
                            <div class="row g-3">
                                <!-- Nom / Intitulé -->
                                <div class="col-12">
                                    <label for="name" class="form-label fw-semibold">Intitulé de l'Activité <span
                                            class="text-danger">*</span></label>
                                    <input type="text" name="name" id="name"
                                        value="{{ old('name', $activity->name ?? '') }}"
                                        class="form-control @error('name') is-invalid @enderror"
                                        placeholder="Ex: Organisation de l'atelier de formation des agents de santé"
                                        required>
                                    @error('name')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <!-- Description -->
                                <div class="col-12">
                                    <label for="description" class="form-label fw-semibold">Description / Tâches prévues
                        ...
                        <div class="mb-4">
                            ...
                            <div class="row g-3">
                                <!-- Budget -->
                                <div class="col-md-4">
                                    <label for="budget" class="form-label fw-semibold">Budget Estimé <span
                                            class="text-danger">*</span></label>
                                    <input type="number" step="any" min="0" name="budget"
                                        id="budget" value="{{ old('budget', $activity->budget ?? '') }}"
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select name="status" id="status"
                                        ...
                                        <option value="planned"
                                            {{ old('status', $activity->status ?? 'planned') == 'planned' ? 'selected' : '' }}>
                                            Planifié</option>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="input-group">
                                        <input type="number" min="0" max="100" step="1"
                                            name="completion_rate" id="completion_rate"
