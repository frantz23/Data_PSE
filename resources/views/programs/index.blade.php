...
<div class="d-flex justify-content-end">
    ...
    <a href="{{ route('admin.program.create') }}" class="btn btn-success m-1">
        ...
        <table  id="Program" class="table">
            <thead>
                <tr>
                    <th scope="col">N#</th>
						...
						<th scope="col">Funding_partner</th>
            ...
            <tbody>
                @foreach($programs as $program)
						...
						<td>
                    <a href="{{ route('admin.program.show', ['id' => $program->id]) }}" class="btn btn-primary btn-sm">
                        <i class="fa-solid fa-eye"></i>
                    </a>
                    <a href="{{ route('admin.program.edit', ['id' => $program->id]) }}" class="btn btn-success btn-sm">
...
@section('scripts')
    ...
    <script>
        ...
        checkbox.onchange = async (event) => {
            ...
            const response = await fetch('/admin/programs/speed/' + id, {
                method: 'PUT',
        ...
        deleteButtons.forEach(deleteButton => {
            deleteButton.addEventListener('click', (event)=>{
                ...
                confirmDeleteBtn.addEventListener('click',async ()=>{
                    const csrfToken = document.head.querySelector('meta[name="csrf-token"]').content;
                    const response = await fetch('/admin/programs/delete/'+id , {
                        method: 'DELETE',
                        headers: {
                            'Content-Type': 'application/json',
                            'X-CSRF-TOKEN': csrfToken
